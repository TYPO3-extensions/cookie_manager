...
/**
 * Test case for class Tx_Cookie_manager_Controller_CookieController.
 *
 * @version $Id$
 ...
 */
class Tx_Cookie_manager_Controller_CookieControllerTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
